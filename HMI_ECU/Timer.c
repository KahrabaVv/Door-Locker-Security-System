...
void TIMER0_init(const Timer_ConfigType* Config_timer0 ){
	...
	TCCR0 = (TCCR0 & 0xF8) | (Config_timer0->prescaler);
...
void TIMER1_init(const Timer_ConfigType* Config_timer1 ){
	...
	TCCR1B = (TCCR1B & 0xF8) | (Config_timer1->prescaler);
...
void TIMER2_init(const Timer_ConfigType* Config_timer2 ){
	...
	TCNT2 = (uint8)(Config_timer2->initial_value); // Set Timer2 initial value to start counting from it
			...
			TCCR2 = (TCCR2 & 0xF8) | (Config_timer2->prescaler);
